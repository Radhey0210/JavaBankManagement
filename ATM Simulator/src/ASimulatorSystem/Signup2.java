...
public class Signup2 extends JFrame implements ActionListener
{
	 JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12;
	  ...
	  Signup2()
	  {
		  //move the text to the center
		   ...
		   String income[]= {"Null","<1,50000","<2,50000","<5,00000","Upto 10,00000","More than 10,00000"};
		   ...
		   getContentPane().setBackground(Color.WHITE); //sets background color
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
		conn c1=new conn();
		String q1 ="insert into signup2 values('"+a+"','"+b+"','"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"','"+c+"')";
